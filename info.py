...
API_ID = int(environ.get('API_ID', '13436676'))
API_HASH = environ.get('API_HASH', 'cd4afff4b02dc967f2db17fd693a83a0')
BOT_TOKEN = environ.get('BOT_TOKEN', "6242228205:AAGaX84FxfsAigZGbIXjHoCw2gNU8u7MuCY")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1313876757').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '--1001829208012').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5602128087').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Farman:abs6wjd8e@cluster0.vrlzy4g.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "farman")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Channel Button Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ak_movie_requst_group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/movie_flix_2')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/ak_movie_requst_group')
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'fe4b0b31442dae98278da2881b6292ff349d15c8')
